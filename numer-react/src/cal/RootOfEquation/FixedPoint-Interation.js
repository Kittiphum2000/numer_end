...
const FixedPoint=()=>{
    ...
    const [Equation,setEquation] = useState("(1/2)(25/c+c)")
    ...
    return (
        <Container>
            {/*Topic method*/}
            <div className="d-flex justify-content-center"><h1>Fixed-point iteration Method</h1></div>     
            {/*------------------------------------------------------------------------------------------------------------------------------*/}
